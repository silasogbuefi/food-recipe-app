    ...
    return (
        <div className="container mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="row-start-2 lg:row-start-auto">
                <div className="h-96 overflow-hidden rounded-xl group">
                    <img
                        ...
                        src={recipeDetailsData?.recipe.image_url} alt="" />
                </div>
            </div>
            <div className="flex flex-col gap-3">
                ...
                <div>
                <span className="text-2xl font-semi-bold text-black">Ingredeints</span>
                <ul className="flex flex-col gap-3">
                    {
                        recipeDetailsData?.recipe?.ingredients.map((ingredient) => <li>
                            <span className="text-2xl font-semi-bold text-black" >{ingredient.quantity} {ingredient.unit}</span>
                            <span className="text-2xl font-semi-bold text-black">{ingredient.description}</span>
                        </li>)
                    }
                </ul>
            </div>
